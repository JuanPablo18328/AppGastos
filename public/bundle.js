...
const cargarGastos = () => {
    ...
    if(gastos && gastos.length > 0){
        ...
        const formatoMoneda = new Intl.NumberFormat('es-MX', { style: 'currency', currency: 'COP' });
...
const cargarTotalGastado = () =>{
    ...
    if(gastos){
        ...
        const formatoMoneda =  new Intl.NumberFormat('en-MX', {style: 'currency', currency: 'COP'});
...
descripcion.addEventListener('blur', (e) => comprobarPrecio());
